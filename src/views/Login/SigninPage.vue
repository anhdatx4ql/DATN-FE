      ...
      <div class="main">
        <div class="side left-side">
          ...
          <div class="login-group" style="position: relative; left: 60px; top: 60px">
            <div
              class="login-title"
              style="font-family: Notosans-semibold; font-size: 30px; position: relative"
            >
              Đăng ký
            </div>
            <div class="login-title" style="position: relative; top: 20px">
              Nếu đã có tài khoản
            </div>
            <div class="login-title" style="position: relative; top: 25px">
              Bạn có thể
              <span @click="gotoLogin" style="cursor: pointer; text-decoration: underline"
                >Đăng nhập</span
              >
              tại đây!
            </div>
        ...
        <div class="side right-side">
          ...
          >
            ...
            <div style="font-family: Poppins-semibold; font-size: 18px; color: #fff">
              0379 459 937
            </div>
          </div>
          ...
          <div class="text" style="position: relative; left: 48px; top: 24px">
            <div
              class="title"
              style="font-size: 32px; font-family: Notosans-semibold; color: #fff"
            >
              Đăng ký tài khoản
            </div>
            <div class="description" style="color: #fff; position: relative; top: 8px">
